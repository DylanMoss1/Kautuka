...
and string_of_func_call ~string_of_var_annot = function
  ...
  | Print expr ->
    Fmt.str "fmt.Println(%s)" (string_of_annotated_expr ~string_of_var_annot expr)
  | Input -> "input()"
  | Open expr -> Fmt.str "open(%s)" (string_of_annotated_expr ~string_of_var_annot expr)
...
and string_of_expr ~string_of_var_annot = function
  ...
  | Paren expr -> Fmt.str "(%s)" (string_of_annotated_expr ~string_of_var_annot expr)
