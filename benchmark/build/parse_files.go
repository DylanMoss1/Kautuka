...
var alpha_9 string
{start := time.Now()
{alpha_10 := open("./benchmark/files/small1.txt")
alpha_5 = alpha_1(read(alpha_10))}
{alpha_11 := open("./benchmark/files/small2.txt")
alpha_6 = alpha_1(read(alpha_11))}
{alpha_12 := open("./benchmark/files/small3.txt")
alpha_7 = alpha_1(read(alpha_12))}
{alpha_13 := open("./benchmark/files/small4.txt")
alpha_8 = alpha_1(read(alpha_13))}
{alpha_14 := open("./benchmark/files/small5.txt")
