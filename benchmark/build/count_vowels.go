...
func alpha_6(alpha_7 string) int {
	...
	var alpha_12 int
	{
    print(fmt.Sprintf("%f", 20.+25.*(math.Pow(float64(len(alpha_7)), 1))))
    print(fmt.Sprintf("%f", 1966.+8.*(math.Pow(float64(len(alpha_7)), 1))))

		if 20.+25.*(math.Pow(float64(len(alpha_7)), 1)) < 1966.+8.*(math.Pow(float64(len(alpha_7)), 1)) {
			start := time.Now()
			{
